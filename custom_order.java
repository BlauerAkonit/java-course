...
public class custom_order {
    ...
    String fName;         /*Vorname*/
    String itemOrder;     /*Bestellnr.*/
    String frostingType;  /*Glasur*/
    String fillingType;   /*Füllung*/
    String toppings;      /*Garnierung*/
    String input;

    double cost = 15.00;
    final double TAX_RATE = .19;
    double tax;
    ...
    System.out.print(fName + ", please see our MENU below: ");
    System.out.print("\n"); /*SHIFT + OPTION + 7*/
    ...
    System.out.println("Whate type of TOPPINGS do you want?");
